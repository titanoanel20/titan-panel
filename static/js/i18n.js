...
const I18N = (() => {
  const dict = {
    fa: {
      ...
      avatar_builtin: 'آواتارهای پیش‌فرض',
      avatar_custom: 'آواتار دلخواه',
      avatar_upload: 'بارگذاری تصویر',
      avatar_reset: 'بازگشت به پیش‌فرض',
      avatar_saved: 'تصویر پروفایل ذخیره شد',
      avatar_hint: 'این تصویر در هدر داشبورد، کنار نام مدیر نمایش داده می‌شود.',
      // public access
    ...
    en: {
      ...
      avatar_builtin: 'Default avatars',
      avatar_custom: 'Custom avatar',
      avatar_upload: 'Upload image',
      avatar_reset: 'Reset to default',
      avatar_saved: 'Profile picture saved',
      avatar_hint: 'This image is shown in the dashboard header, next to the admin name.',
