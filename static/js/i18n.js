...
const I18N = (() => {
  const dict = {
    fa: {
      ...
      // profiles
      sec_profiles: 'پروفایل‌های اتصال', profile_name: 'نام پروفایل',
      add_profile: 'پروفایل جدید', edit_profile: 'ویرایش پروفایل',
      builtin: 'پیش‌فرض', custom: 'دلخواه',
      select_profile: 'پروفایل (اختیاری)', default_profile: 'پروفایل پیش‌فرض پنل',
      profile_none: 'بدون پروفایل (تنظیم دستی)',
      profile_created: 'پروفایل ساخته شد', profile_updated: 'پروفایل ویرایش شد',
      profile_deleted: 'پروفایل حذف شد', delete_confirm_profile: 'این پروفایل حذف شود؟',
      // public access
    ...
    en: {
      ...
      sec_profiles: 'Connection profiles', profile_name: 'Profile name',
      add_profile: 'New profile', edit_profile: 'Edit profile',
      builtin: 'Built-in', custom: 'Custom',
      select_profile: 'Profile (optional)', default_profile: 'Panel default profile',
      profile_none: 'No profile (manual)',
      profile_created: 'Profile created', profile_updated: 'Profile updated',
      profile_deleted: 'Profile deleted', delete_confirm_profile: 'Delete this profile?',
